...
public class CustomOnClickEditor : Editor
{
    ...
    SerializedProperty onQuestInfoViewEventProp;
    ...
    void OnEnable()
    {
        ...
        onGameViewEventProp = serializedObject.FindProperty("_gameViewEvent");
        onQuestInfoViewEventProp = serializedObject.FindProperty("_questInfoViewEvent");
    ...
    public override void OnInspectorGUI()
    {
        ...
        switch (buttonOwner)
        {
            ...
            case ButtonOwner.QuestInfo:
                EditorGUILayout.PropertyField(onQuestInfoViewEventProp);
                break;
            default: break;
        }
