...
public class DataService  {
    ...
    public static DataService MAINDB
    {
        get
        {
            if (_serviceWARSQL == null) _serviceWARSQL = new DataService("MAINDB.sqlite");
...
*/
    ...
    public void CreateLazyTables()
    {
        _connection.CreateTable<Enemy>();
        _connection.CreateTable<EnemyProps>();
        _connection.CreateTable<Hero>();
    }
    
    public Enemy GetEnemy(int ID)
    {
        return _connection.Table<Enemy>().Where(x=>x.ID == ID).FirstOrDefault();
    }

    public Hero GetHero(int ID)
    {
        return _connection.Table<Hero>().Where(x => x.ID == ID).FirstOrDefault();
    }
}
